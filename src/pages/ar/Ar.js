...
import marker from '../assets/markers/Monalisa-marker.patt';
...
import sound1 from '../assets/sounds/dsbgdth1.mp3';
import sound2 from '../assets/sounds/dsbgsit2.mp3';
import doom from '../assets/sounds/doom.mp3';
...
const Ar = () => {
  ...
  return (
    <a-scene arjs="sourceType: webcam; debugUIEnabled: false;">
      ...
      <a-marker id="objmk" type="pattern" url={marker}>
        <a-gltf-model
          id="mkMonster"
          visible="true"
          src="#monster"
